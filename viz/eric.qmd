...
if (file.exists(shp_path)) {
  ...
  com_France = st_read(shp_path, quiet=T)
  list_bdx<-c('Barsac', 'Haut-Médoc', 'Listrac-Médoc','Margaux', 'Médoc','Pauillac','Pessac-Léognan','Saint-Estèphe','Saint-Julien','Sauternes')
  aoc_medoc<-com_France %>% filter(app %in% list_bdx)
  
  tmap_mode("view")
  tm_shape(aoc_medoc)+ tm_polygons(
      col = "app",
      popup.vars = c("Appelation" = "app", "Commune" = "nomcom"),
      title = "AOC")+ tm_view()
}
