...
<font color="#1917B7"> On commence par planter le manioc, base de l'alimentation bushinenguée, il faudra environ 18 mois pour commencer la récolte.</font> [@cr-exploitation1]{scale-by="0.5" pan-to="25%,-35%"}
...
<font color="#1917B7">Ainsi que les bananiers; les bananes sont utilisés comme fruits ou comme légumes après cuisson (attention ! ce ne sont pas les mêmes variétés)</font> [@cr-exploitation2]{scale-by="0.5" pan-to="25%,-35%"}
...
<font color="#1917B7">On trouve aussi des patates douces, dont la récolte est assez rapide, moins de 10 mois après plantation.</font>[@cr-exploitation3]{scale-by="0.5" pan-to="25%,-35%"}
...
<font color="#1917B7">Et des plantations d'ananas, d'arbre fruitiers, et de palmiers à graines.</font>[@cr-exploitation4]{scale-by="0.5" pan-to="25%,-35%"}
